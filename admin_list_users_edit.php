<?php
	...
	require_once (__DIR__.'/core/functions/fnc_gtUser.php');
            ...
            <form action="admin_list_users_edit.php?id=<?php echo $_GET['id']?>" method="POST">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="reg_gender" value="1" <?php echo ($gender==1 ? 'checked' : '');?>> Male
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="reg_gender" value="2" <?php echo ($gender==2 ? 'checked' : '');?>> Female
                    </label>
                </div>
                <div class="form-group">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="reg_rank" value="1" <?php echo ($rank==1 ? 'checked' : '');?>> Student
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="reg_rank" value="2" <?php echo ($rank==2 ? 'checked' : '');?>> Teacher
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="radio" name="reg_rank" value="3" <?php echo ($rank==3 ? 'checked' : '');?>> Administrator
                    </label>
                </div>
