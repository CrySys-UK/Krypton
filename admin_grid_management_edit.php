            ...
            <form action="admin_grid_management_edit.php?id=<?php echo $_GET['id']?>" method="POST">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="admin_access" value="1" <?php echo ($aa==1 ? 'checked' : '');?>> Administrator Access
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="teacher_access" value="1" <?php echo ($ta==1 ? 'checked' : '');?>> Teacher Access
                    </label>
                    <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" name="student_access" value="1" <?php echo ($sa==1 ? 'checked' : '');?>> Student Access
                    </label>
                </div>
